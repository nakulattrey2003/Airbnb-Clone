...
const createListingController = async (req, res) => {
  try {
    ...
    if (!listingPhotos) {
      return res.status(400).send("No listing photos provided.");
    }
...
const getListingByCategoryController = async (req, res) => {
...
const getListingBySearchController = async (req, res) => {
...
const getListingDetailsController = async (req, res) => {
  try {
